...
public final class ImageUtils {
     ...
     * @param h
     */
    public static void downscale(final int[] in, final int srcW, final int srcH, final int w, final int h) {
     ...
     */
    public static void pureDownscale(final int[] data, final int srcW, final int srcH, final int w, final int h, final boolean preserveAspectRatio) {
     ...
     * @param preserveAspectRatio
     */
    public static void pureOpaqueDownscale(final int[] data, final int srcW, final int srcH, final int w, final int h, final boolean preserveAspectRatio) {
        final int predictedCount = 1 + (srcW / w);
        final int[] lut = new int[predictedCount << 8];
    ...
    public static Image cropImage(Image stream, int w, int h) {
        Image original = Image.createImage(stream); // 320 x 240
        Image crop = Image.createImage(w, h);
     ...
     */
    public static Image scaleImage(Image sourceImage, int newImageWidth, int newImageHeight) {
